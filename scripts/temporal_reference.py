...
DATE_TEXT = [
    '1-1-1', '01-1-1', '-1-1-1', '-01-1-1', '1-1-1 (BC)', '01-1-1 (BC)',
    '\t1-1-1', '0000000000000001-01-01', '2000-01-01 12:34:56',
    '2000-01-01T1:2', '1-1-1 12:34:56', '2000-01-01 24:00:00',
    '2000-01-01 24:00:00.000001', '2000-01-01 12:34:56 Europe/Amsterdam',
    '5881580-07-10 24:00:00', '5877642-06-25 (BC) 24:00:00',
    '290309-12-21 (BC) 23:59:59.999999', '5881580-07-10 25:00:00',
    '5881580-07-11 12:00:00', '2000-01-01junk', '2000-01-011',
    '2000-01-01\t', '\tinfinity\t', 'inf ', '1000000000-01-01',
    '2147483648-01-01', '2000/01/02 1:', '2000 01 02 1:2:3',
    '2000-01-01 12:34:56+02junk', '2000-01-01 12:34:56+99:99:99',
    '2000-01-01 12:34:56Z', '2000-01-01 12:34:56  UTC',
]
SQL += [f"SELECT TRY_CAST('{value}' AS DATE),TRY_CAST('{value}'::VARIANT AS DATE)"
        for value in DATE_TEXT]
SQL += [f"SELECT CAST('{value}' AS DATE)" for value in
        ['1-1-1', '1-1-1junk', '1000000000-01-01', '2000-02-30',
         '5881580-07-10 25:00:00', '5881580-07-10 24:00:00']]
SQL += [f"SELECT CAST('{value}'::VARIANT AS DATE)" for value in
        ['1-1-1', '2000-01-01 12:34:56', '2000-02-30']]
SQL += [
    "SELECT TRY_CAST({'d':'1-1-1'}::VARIANT AS STRUCT(d DATE)),CAST({'d':'01-1-1'}::VARIANT AS STRUCT(d DATE))::VARCHAR",
    "SELECT TRY_CAST(['2000-01-01 12:34:56','5881580-07-10 24:00:00'] AS DATE[])::VARCHAR,TRY_CAST(['01-1-1','1-1-1']::VARIANT AS DATE[])",
    "SELECT DATE '5881580-07-10'::VARIANT::DATE,DATE '5877642-06-25 (BC)'::VARIANT::DATE",
]
SQL += [
