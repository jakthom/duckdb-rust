...
`target/next-batch/performance/g06/final-complete-{release,development,fastest}-21.json`;
the comparable CPU, peak-RSS, block-I/O and throughput campaign is
`target/next-batch/performance/g06/final-complete-process-21.json`. Both pinned
...
`target/next-batch/performance/g08/final-complete-{release,development,fastest}-21.json`;
the comparable CPU, peak-RSS, block-I/O and throughput campaign is
`target/next-batch/performance/g08/final-complete-process-21.json`. Both pinned
campaigns, the joint faster-reference latency gate and every independent process
